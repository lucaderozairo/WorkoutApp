Title: Training Plans — One-page Design Brief

Purpose:
- Discover, subscribe to, and manage training plans.

Audience:
- Product, Designer, Coaching team.

Goals:
- Reduce friction to subscribe and begin a plan; show progress and commitment.

Layout & Structure:
- Plan catalog (cards), active plan spotlight, progress widget.

Key Components:
- Plan card (duration, focus, intensity), start/subscribe CTA, progress meter.

States & Interactions:
- Preview plan outline, subscribe flow, pause/cancel controls.

Content Guidelines:
- Use consistent filtering (goal, duration), show commitment estimate.

Accessibility:
- Descriptive labels for plan intensity and expected weekly commitment.

Assets for Figma:
- Plan card variants, progress bar component, sample plan content.

Acceptance Criteria:
- Users can subscribe to a plan within 3 taps and see onboarding steps.
